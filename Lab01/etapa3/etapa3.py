...
from functions.decoders import decode_nrz, decode_manchester
from functions.encoders import encode_nrz, encode_manchester
...
for i in range(31, 126, 1):
    ...
    try:
        ...
        decoded = decode_manchester(noisy_signal, num_bits)
    except NameError:
